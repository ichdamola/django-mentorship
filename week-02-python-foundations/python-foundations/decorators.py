...
def repeat(times: int) -> Callable:
    """
    Decorator that repeats function after execution

    When a decorator takes arguments, we need three levels:
    1. The outer function takes a decorator arguments
...
# ===============================================================
# Part 4: Class-based Decorators (like Django's method_decorator)
# ===============================================================
